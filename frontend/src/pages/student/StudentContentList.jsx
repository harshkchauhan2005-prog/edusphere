...
const StudentContentList = ({ type }) => {
    ...
    const getTitle = () => {
        switch (type) {
            case 'materials': return 'Reading Materials';
            case 'quizzes': return 'Course Quizzes';
        ...
        <div className="animate-in fade-in zoom-in-95 duration-500 mt-6">
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">View all your {type} across your enrolled courses.</p>
                </div>
            </div>
            ...
            {items.length === 0 ? (
                <div className="bg-white dark:bg-card-dark border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-3xl p-16 text-center text-slate-500 shadow-sm">
                    ...
                    <p className="text-sm">There are no {type} posted in any of your enrolled courses yet.</p>
                </div>
            ) : (
