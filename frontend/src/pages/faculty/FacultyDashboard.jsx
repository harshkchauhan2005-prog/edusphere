...
const FacultyDashboard = () => {
    ...
    return (
        <div className="flex min-h-screen bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-100 transition-colors duration-200">
            {/* Sidebar Navigation */}
            <aside className="w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark hidden lg:flex flex-col fixed h-full z-50">
                ...
                <div className="p-4 border-t border-slate-200 dark:border-slate-800">
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-all text-red-500 text-left"
                    >
            ...
            <main className="flex-1 lg:ml-64 p-4 lg:p-8 relative">
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-slate-500 dark:text-slate-400">Welcome back, {user?.name || 'Professor'}</p>
                    </div>
